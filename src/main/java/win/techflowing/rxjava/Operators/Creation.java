...
//        error();
    ...
    private static void just() {
        Observable.just(1, 2, 3)
                .subscribe(SubscriberFactory.getIntegerSubscriber("just()"));
    }
    ...
    private static void range() {
        Observable.range(10, 5).subscribe(SubscriberFactory.getIntegerSubscriber("range()"));
    }
    ...
    /**
     * timer 操作符，
     * timer(4, 2, TimeUnit.SECONDS),在 4 秒之后，每间隔 2 秒，发送一个数字
     * timer(4, TimeUnit.SECONDS) 在 4 秒后，发出一个数字
     */
    private static void timer() {
        Observable.timer(4, 2, TimeUnit.SECONDS).subscribe(new Subscriber<Long>() {
            @Override
            public void onCompleted() {
                System.out.println("complete");
            }
    ...
    private static void error() {
        Observable.error(new Throwable("这是一个Error")).subscribe(new Subscriber<Object>() {
            @Override
            public void onCompleted() {
