...
public class Aggregate {
    ...
    private static void concat() {
        ...
        Observable.concat(observable1, observable2, observable3)
                .subscribe(SubscriberFactory.getIntegerSubscriber("concat()"));
    }
    ...
    /**
     * collect用来将源Observable发射的数据给收集到一个数据结构里面，
     * 需要使用两个参数：
     * 一个产生收集数据结构的函数。
        ...
        Observable.interval(1, TimeUnit.SECONDS)
                ...
                .subscribe(new Subscriber<ArrayList<Long>>() {
                    ...
                    public void onNext(ArrayList<Long> longs) {
                        System.out.println("collect() onNext:" + longs.toString());
                    }
                });
    }
        ...
        Observable.interval(1, TimeUnit.SECONDS)
                ...
                .subscribe(new Subscriber<List<Long>>() {
                    ...
                    public void onNext(List<Long> longs) {
                        System.out.println("toList() onNext:" + longs.toString());
                    }
                });
    }
    ...
    private static void toSortList() {
        Observable.just(1, 2, 0, 10, 4, 6, 5)
                .toSortedList()
                .subscribe(new Subscriber<List<Integer>>() {
                    ...
                    @Override
                    public void onError(Throwable e) {
                        System.out.println("toSortList() error:" + e.getMessage());
                    }

                    @Override
                    public void onNext(List<Integer> longs) {
                        System.out.println("toSortList() onNext:" + longs.toString());
                    }
                });
        ...
        Observable.just(1, 2, 3, 4)
                ...
                .subscribe(new Subscriber<Map<String, Integer>>() {
                    ...
                    public void onNext(Map<String, Integer> stringIntegerMap) {
                        System.out.println("toMap() onNext:" + stringIntegerMap.toString());
                    }
                });
    }
        ...
        Observable.just(1, 2, 3, 4, 5)
                ...
                .subscribe(new Subscriber<Map<String, Collection<Integer>>>() {
                    ...
                    public void onNext(Map<String, Collection<Integer>> stringCollectionMap) {
                        System.out.println("toMultiMap() onNext:" + stringCollectionMap);
                    }
                });
    }
}
