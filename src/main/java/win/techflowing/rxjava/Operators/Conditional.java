...
//        takeUntil();
    ...
    private static void amb() {
        ...
        Observable<Integer> observable2 = Observable.just(4, 5, 6).delay(2, TimeUnit.SECONDS);
        Observable<Integer> observable3 = Observable.just(7, 8, 9).delay(1, TimeUnit.SECONDS);

        Observable.amb(observable1, observable2, observable3)
                .subscribe(SubscriberFactory.getIntegerSubscriber("amb()"));
    }
    ...
    private static void defaultIfEmpty() {
        ...
        Observable.from(items)
                .defaultIfEmpty(100)
                .subscribe(SubscriberFactory.getIntegerSubscriber("defaultIfEmpty()"));
