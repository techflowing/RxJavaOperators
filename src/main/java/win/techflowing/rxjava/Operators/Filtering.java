...
//        distinctUntilChanged();
    ...
    /**
     * filter操作符,对源Observable产生的结果按照指定条件进行过滤
     * 只有满足条件的结果才会提交给订阅者
     */
    ...
    /**
     * take操作符,把源Observable产生的结果的前n项提交给订阅者，
    ...
    /**
     * takeLast操作符,把源Observable产生的结果的后n项提交给订阅者，
     * 提交时机是Observable发布onCompleted通知之时
     */
    ...
    /**
     * takeLastBuffer 操作符，与takeLast 相似，不同的是最后封装成List返回
     * 时间或者数量过滤
     */
        ...
        Observable.just(1, 2, 3, 4, 5, 6)
                ...
                .subscribe(new Subscriber<List<Integer>>() {
                    ...
                    public void onError(Throwable e) {
                        System.out.println("takeLastBuffer() error:" + e.getMessage());
                    }

                    @Override
                    public void onNext(List<Integer> integers) {
                        System.out.println("takeLastBuffer() onNext:" + integers.toString());
                    }
                });
    }
    ...
    /**
     * Sample操作符,定时地取发射源Observable最近发射的数据，其他的都会被过滤掉，
     * 等效于ThrottleLast操作符。
     */
    ...
    private static void throttleLast() {
        Observable.interval(1, TimeUnit.SECONDS)
                ...
                .subscribe(new Subscriber<Long>() {
                    ...
                    @Override
                    public void onError(Throwable e) {
                        System.out.println("throttleLast() error:" + e.getMessage());
                    }
    ...
    private static void throttleFirst() {
        Observable.interval(1, TimeUnit.SECONDS)
                ...
                .subscribe(new Subscriber<Long>() {
                    ...
                    @Override
                    public void onError(Throwable e) {
                        System.out.println("throttleFirst() error:" + e.getMessage());
                    }
    ...
    private static void distinct() {
        Observable.just(1, 1, 2, 3, 4, 4, 5, 6, 6)
                .distinct()
    ...
    private static void distinctUntilChanged() {
        Observable.just(1, 1, 2, 3, 1, 1, 2, 4, 4, 6)
                .distinctUntilChanged()
    ...
    private static void ofType() {
        Observable.just(1, 2, 3.0, 4, 5, 6.0, 7)
    ...
    private static void ignoreElements() {
        Observable.create(new Observable.OnSubscribe<Integer>() {
            ...
            public void call(Subscriber<? super Integer> subscriber) {
                ...
                .ignoreElements()
                .subscribe(getIntegerSubscriber("ignoreElements()"));
    }
